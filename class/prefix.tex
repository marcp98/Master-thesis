...
\LetLtxMacro{\todoside}{\todo}
\renewcommand{\todo}[2][]{\todoside[inline, #1]{#2}}
...
% many provided by physics package
\newcommand{\nM}{\mathbb}
\newcommand{\nR}{\mathbb{R}}
\newcommand{\nN}{\mathbb{N}}
\newcommand{\nZ}{\mathbb{Z}}
...
\newcommand{\ddx}{\dv{x}}
\newcommand{\ddt}[1]{\dv{#1}{t}}
\newcommand{\ddxn}[1]{\dv[n]{#1}{x}} %{\frac{\mathrm{d}^{#1}}{\mathrm{d} x^{#1}}}
\newcommand{\bint}[2]{\int\limits_{#1}^{#2}}
\newcommand{\aint}[1]{\int\limits_{#1}^{}}
\newcommand{\divtxt}{\text{div }}
\newcommand{\rottxt}{\text{rot }}

\newcommand{\diag}[1]{\mathrm{diag}\left(#1\right)}

\newcommand{\LL}{\mathcal{L}}

\newcommand{\gradtxt}{\text{grad} \ }
